$("head").append('<link href="../Common/extensions/ChartJSWidget/ui/radarchart/jslibrary/Chart.min.css" rel="stylesheet">');$("body").append('<script type="text/javascript" src="../Common/extensions/ChartJSWidget/ui/radarchart/jslibrary/Chart.min.js">\x3c/script>');Chart.platform.disableCSSInjection=!0;
