$("head").append('<link href="../Common/extensions/RadarChartWidget/ui/radarchart/jslibrary/Chart.min.css" rel="stylesheet">');$("body").append('<script type="text/javascript" src="../Common/extensions/RadarChartWidget/ui/radarchart/jslibrary/Chart.min.js">\x3c/script>');Chart.platform.disableCSSInjection=!0;
